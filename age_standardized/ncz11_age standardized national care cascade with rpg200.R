...
n5_sy %>% 
  write_csv(.,file = "age_standardized/ncz11_total age standardized national care cascade with rpg200.csv")
...
bind_rows(nfhs5_svysummary,
  ...
  write_csv(.,path = "age_standardized/ncz11_age standardized national care cascade with rpg200.csv")
