...
# NATIONAL ----------
unmet_svysummary_dmtreat_national <- map_dfr(group_vars[-1],
                                     function(g_v){
                                       id_vars = c(g_v);
                                       n5_sy <- svysummary(nfhs5dmtreatz_svydesign,
                                                           # c_vars = continuous_vars,
...
# Regional -----------
unmet_svysummary_dmtreat_regional <- map_dfr(group_vars,
                                          function(g_v){
...
bind_rows(unmet_svysummary_dmtreat_national,
          unmet_svysummary_dmtreat_regional) %>% 
