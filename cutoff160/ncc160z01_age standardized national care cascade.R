...
n5_sy %>% 
  write_csv(.,file = "cutoff160/ncc160z01_total age standardized national care cascade.csv")
...
write_csv(.,path = "cutoff160/ncc160z01_age standardized national care cascade.csv")
