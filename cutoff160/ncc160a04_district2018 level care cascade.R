...
source("preprocessing/ncpre33_nfhs5 total svydesign with rpg160.R")
...
write_csv(district_svysummary,file = "cutoff160/ncc160a04_district2018 level care cascade.csv")

# df <- read_csv("analysis/nca04_district2018 level care cascade.csv") %>% 
...
#             by=c("D_CODE"))
# write_csv(df,file = "analysis/nca04_district2018 level care cascade.csv")
# 
