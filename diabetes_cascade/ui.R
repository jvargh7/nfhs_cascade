...
sidebar_overview <- conditionalPanel(condition="input.selectedpanel==2",
                                     ...
                                     selectInput("cutoffinput1","Diabetes Cut-point:",choices = c("220 mg/dL","200 mg/dL","160 mg/dL"),selected = "220 mg/dL"),
...
sidebar_state <- conditionalPanel(condition="input.selectedpanel==3",
                                     ...
                                     selectInput("cutoffinput2","Diabetes Cut-point:",choices = c("220 mg/dL","200 mg/dL","160 mg/dL"),selected = "220 mg/dL"),
...
sidebar_stratified <- conditionalPanel(condition="input.selectedpanel==4",
                                  ...
                                  selectInput("cutoffinput3","Diabetes Cut-point:",choices = c("220 mg/dL","200 mg/dL","160 mg/dL"),selected = "220 mg/dL"),
