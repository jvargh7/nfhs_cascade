...
sidebar_overview <- conditionalPanel(condition="input.selectedpanel==2",
                                     ...
                                     selectInput("cutoffinput1","Diabetes Cut-point:",choices = c("220 mg/dL","200 mg/dL"),selected = "220 mg/dL"),
...
sidebar_state <- conditionalPanel(condition="input.selectedpanel==3",
                                     ...
                                     selectInput("cutoffinput2","Diabetes Cut-point:",choices = c("220 mg/dL","200 mg/dL"),selected = "220 mg/dL"),
...
sidebar_stratified <- conditionalPanel(condition="input.selectedpanel==4",
                                  ...
                                  selectInput("cutoffinput3","Diabetes Cut-point:",choices = c("220 mg/dL","200 mg/dL"),selected = "220 mg/dL"),
...
panel_overview <- tabPanel("Overview",value = 2,
                           ...
                           fluidRow(
                             ...
                             h5("In the meantime, you can easily visualize state-level summary statistics at:",align='center'),
                             h5(tags$a("shodha.stopncd.org", href="http://157.245.97.237/",target="_blank"),align='center'),
